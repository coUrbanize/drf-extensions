# -*- coding: utf-8 -*-
from rest_framework_extensions_3.compat import get_concrete_model
from rest_framework_extensions_3.utils import get_model_opts_concrete_fields, get_rest_framework_features
